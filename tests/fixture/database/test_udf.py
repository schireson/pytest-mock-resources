...
class TestUdf:
    @pytest.mark.parametrize(
        ...
        (
            ...
            (
                'second', 1, datetime(2018, 1, 1, tzinfo=pytz.UTC),
                datetime(2018, 1, 1, 0, 0, 1, tzinfo=pytz.UTC)
            ),
            (
                'minute', 1, datetime(2018, 1, 1, tzinfo=pytz.UTC),
                datetime(2018, 1, 1, 0, 1, 0, tzinfo=pytz.UTC)
            ),
            (
                'hour', 1, datetime(2018, 1, 1, tzinfo=pytz.UTC),
                datetime(2018, 1, 1, 1, 0, 0, tzinfo=pytz.UTC)
            ),
            (
                'day', 1, datetime(2018, 1, 1, tzinfo=pytz.UTC),
                datetime(2018, 1, 2, 0, 0, 0, tzinfo=pytz.UTC)
            ),
            (
                'week', 1, datetime(2018, 1, 1, tzinfo=pytz.UTC),
                datetime(2018, 1, 8, 0, 0, 0, tzinfo=pytz.UTC)
            ),
            (
                'month', 1, datetime(2018, 1, 1, tzinfo=pytz.UTC),
                datetime(2018, 2, 1, 0, 0, 0, tzinfo=pytz.UTC)
            ),
            (
                'year', 1, datetime(2018, 1, 1, tzinfo=pytz.UTC),
    ...
    @pytest.mark.parametrize(
        ...
        (
            ...
            (
                'second', datetime(2018, 1, 1, tzinfo=pytz.UTC),
                datetime(2018, 1, 2, tzinfo=pytz.UTC), 86400
            ),
            (
                'minute', datetime(2018, 1, 1, tzinfo=pytz.UTC),
                datetime(2018, 1, 2, tzinfo=pytz.UTC), 1440
            ),
            (
                'hour', datetime(2018, 1, 1, tzinfo=pytz.UTC),
                datetime(2018, 1, 2, tzinfo=pytz.UTC), 24
            ),
            (
                'day', datetime(2018, 1, 1, tzinfo=pytz.UTC),
                datetime(2018, 1, 2, tzinfo=pytz.UTC), 1
            ),
            (
                'week', datetime(2018, 1, 1, tzinfo=pytz.UTC),
                datetime(2018, 1, 31, tzinfo=pytz.UTC), 4
            ),
            (
                'month', datetime(2018, 1, 1, tzinfo=pytz.UTC),
                datetime(2018, 2, 1, tzinfo=pytz.UTC), 1
            ),
            (
                'year', datetime(2018, 1, 1, tzinfo=pytz.UTC),
                datetime(2018, 12, 31, tzinfo=pytz.UTC), 0,
            ),
            (
                'year', datetime(2018, 12, 31, tzinfo=pytz.UTC),
                datetime(2019, 1, 1, tzinfo=pytz.UTC), 1,
            ),
        )
    )
    def test_datediff(
