...
try:
    ...
    boto3 = ImportAdaptor(
        "boto3", "redshift", extensions=ImportAdaptor("boto3", "redshift", cursor=ImportAdaptor)
    )
...
try:
    ...
    moto = ImportAdaptor(
        "moto", "redshift", extensions=ImportAdaptor("moto", "redshift", cursor=ImportAdaptor)
    )
...
try:
    ...
    sqlparse = ImportAdaptor(
        "sqlparse",
        "redshift",
        extensions=ImportAdaptor("sqlparse", "redshift", cursor=ImportAdaptor),
    )

try:
    import pymongo
except ImportError:
    pymongo = ImportAdaptor(
        "pymongo", "mongo", extensions=ImportAdaptor("pymongo", "mongo", cursor=ImportAdaptor)
    )
